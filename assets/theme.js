...
/**
 * @license
 * lodash 4.17.20 (Custom Build) lodash.com/license | Underscore.js 1.8.3 underscorejs.org/LICENSE
...
t===an&&(t=r),Q(t)?t.call(n):t},a.size=function(n){return null==n?0:(n=L(n)?n:en(n),n.length)},a.some=function(n,t,r){return t=r?an:t,S(n,d(t))},a.uniqueId=function(n){var t=++An;return rn(n)+t},a.each=M,a.first=G,fn(a,function(){var n={};return g(a,function(t,r){En.call(a.prototype,r)||(n[r]=t)}),n}(),{chain:false}),a.VERSION="4.18.20",$n("pop join replace reverse split push shift sort splice unshift".split(" "),function(n){var t=(/^(?:replace|split)$/.test(n)?String.prototype:On)[n],r=/^(?:push|sort|unshift)$/.test(n)?"tap":"thru",e=/^(?:pop|join|replace|shift)$/.test(n);
...
theme.variables = {
  ...
  mediaQueryMedium    : 'screen and (min-width: 768px) and (max-width: 1199px)',
...
theme.afterCartLoad = function() {
  theme.cache.$body.on('ajaxCart.afterCartLoad', function(evt, cart) {
    ...
    if (cart.items.length > 0) {
      ...
      theme.cache.$cartCustom.addClass('custom-cart-icon-filled');      
      theme.cache.$cartCustom.removeClass('custom-cart-icon');
    } else {
      theme.cache.$cartBuggle.removeClass('cart-link__bubble--visible');      
      theme.cache.$cartCustom.addClass('custom-cart-icon');
      theme.cache.$cartCustom.removeClass('custom-cart-icon-filled');
    }
  });
...
theme.checkoutIndicator = function() {
  ...
  theme.cache.$body.on('click', '#poundcheckout', function(event) {
    event.stopPropagation();
    $(this).addClass('btn--loading');
    redirectPost('https://sticker-pet-uk.myshopify.com/cart/'+checkoutProducts, {'attributes[Order]': checkoutOrder,'attributes[Image]': checkoutImages});
    //console.log('https://sticker-pet-uk.myshopify.com/pages/addcart?products='+checkoutProducts+'&'+'images='+checkoutImages);
    //window.location.replace('https://sticker-pet-uk.myshopify.com/pages/addcart?products='+checkoutProducts+'&'+'images='+checkoutImages);
  });
};
...
$(document).ready(function() {
  ...
  var tech = getUrlParameter('cartopen');
...
function redirectPost(location, args)
{
  ...
  form += '<textarea name="note" id="CartNote">'+$('#CartSpecialInstructions').val()+'</textarea>';
